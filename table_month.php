    ...
    <body>
        ...
        <div class="container-report-table">
            <section class="products">
                <h1 class="heading">Lista diaria de Visitas</h1>

                <div class="btn-container">
                    <a href="excel_report_month.php" onclick="confirmation2()" class="report-btn">Descargar Reporte</a>        
                    <a href="mailto:?subject=Reporte Diario de Visitas -  AMCARE&body=Adjunto encontrarás el Reporte de Registros de la Bitácora de Visitas a AMCARE. %0D%0A%0D%0APuedes utilizar Excel para abir el archivo adjunto; si al hacerlo aparece una advertencia símplemente presiona en el botón SÍ y podrás consultarlo. %0D%0A¡Que tengas un excelente turno!" class="report-btn"><i class="fa-solid fa-envelope"></i> Abrir correo</a>
                </div>
                <section class="report-container">
                    <table class="report-table">
                        <tr class="report-tr">
                            ...
                            WHERE MONTH(VI.date) = MONTH(current_date())
